...
export const urls = pgTable('urls',
  {
    ...
    oldClicks: integer('old_clicks').default(0).notNull(),
    createdAt: timestamp('created_at').defaultNow().notNull(),
    dailyUniqueVisitors: integer('daily_unique_visitors').default(0).notNull(),
    oldDailyUniqueVisitors: integer('old_daily_unique_visitors').default(0).notNull(),
    bounceRate: integer('bounce_rate').default(0).notNull(),
    oldBounceRate: integer('old_bounce_rate').default(0).notNull(),
  },
  (urls) => [
